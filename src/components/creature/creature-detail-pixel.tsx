      ...
      <div className='relative z-10 w-full min-h-screen p-4 md:p-6'>
        <div className='max-w-7xl mx-auto space-y-4'>
          ...
          <button
            ...
            className='group relative bg-slate-900 hover:bg-slate-800 border-4 border-yellow-500 rounded-xl px-5 py-3 font-black text-yellow-400 transition-all duration-300 active:scale-95 shadow-lg hover:shadow-yellow-500/50 overflow-hidden'
          >
            ...
            <span className='relative z-10 flex items-center gap-2 font-mono tracking-wider [text-shadow:2px_2px_0px_rgba(0,0,0,0.8)]'>
              ...
              <div className='relative p-6 space-y-4'>
                <div className='flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4'>
                  <div className='flex items-center gap-4'>
                    <div className='w-16 h-16 bg-yellow-500 flex items-center justify-center text-slate-900 font-black text-3xl border-4 border-yellow-600 shadow-lg relative overflow-hidden'>
                  ...
                  <button
                    ...
                    className={`
                      ...
                      border-4 transition-all duration-300 active:scale-95 shadow-lg overflow-hidden
                      [text-shadow:2px_2px_0px_rgba(0,0,0,0.5)]
          ...
          <div className='grid grid-cols-1 lg:grid-cols-5 gap-4'>
            ...
            <div className='lg:col-span-3 space-y-4'>
              ...
              <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
                ...
                {/* Traits */}
                <div className='bg-slate-900 rounded-xl border-4 border-purple-500 p-4 shadow-xl hover:shadow-purple-500/50 transition-all duration-300 relative overflow-hidden'>
                  <div className='absolute inset-0 bg-[linear-gradient(to_bottom,transparent_50%,rgba(0,0,0,0.1)_50%)] bg-[size:100%_4px] pointer-events-none' />
                  <div className='relative z-10'>
                ...
                {/* Infos */}
                <div className='bg-slate-900 rounded-xl border-4 border-blue-500 p-4 shadow-xl hover:shadow-blue-500/50 transition-all duration-300 relative overflow-hidden'>
                  <div className='absolute inset-0 bg-[linear-gradient(to_bottom,transparent_50%,rgba(0,0,0,0.1)_50%)] bg-[size:100%_4px] pointer-events-none' />
                  <div className='relative z-10'>
                    <div className='flex items-center gap-2 mb-3'>
                      <span className='text-xl'>📅</span>
                ...
                {/* Accessoires */}
                <div className='bg-slate-900 rounded-xl border-4 border-pink-500 p-4 shadow-xl hover:shadow-pink-500/50 transition-all duration-300 relative overflow-hidden'>
                  <div className='absolute inset-0 bg-[linear-gradient(to_bottom,transparent_50%,rgba(0,0,0,0.1)_50%)] bg-[size:100%_4px] pointer-events-none' />
                  <div className='relative z-10'>
                    <div className='flex items-center gap-2 mb-3'>
                      <span className='text-xl'>👕</span>
                ...
                {/* Fond d'écran */}
                <div className='bg-slate-900 rounded-xl border-4 border-orange-500 p-4 shadow-xl hover:shadow-orange-500/50 transition-all duration-300 relative overflow-hidden'>
                  <div className='absolute inset-0 bg-[linear-gradient(to_bottom,transparent_50%,rgba(0,0,0,0.1)_50%)] bg-[size:100%_4px] pointer-events-none' />
                  <div className='relative z-10'>
                    <div className='flex items-center gap-2 mb-3'>
              ...
              {/* 💡 ASTUCE ARCADE */}
              <div className='relative'>
                <div className='absolute -inset-0.5 bg-gradient-to-r from-yellow-500 via-orange-500 to-yellow-500 rounded-xl blur opacity-50' />
                <div className='relative bg-slate-900 rounded-xl border-4 border-yellow-500 p-4 overflow-hidden'>
                  <div className='absolute inset-0 bg-[linear-gradient(to_bottom,transparent_50%,rgba(0,0,0,0.1)_50%)] bg-[size:100%_4px] pointer-events-none' />
                  <div className='relative z-10 flex items-center gap-3'>
                    <span className='text-2xl animate-pulse'>💡</span>
                    <p className='text-sm text-yellow-100 font-mono [text-shadow:1px_1px_0px_rgba(0,0,0,0.8)]'>
