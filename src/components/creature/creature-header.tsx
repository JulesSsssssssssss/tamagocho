...
const CreatureHeader = memo(function CreatureHeader ({
  ...
  return (
    <header className='bg-gradient-to-br from-white via-lochinvar-50 to-fuchsia-blue-50 rounded-3xl p-6 shadow-lg ring-1 ring-white/80'>
      <div className='flex items-center justify-between gap-4'>
        ...
        <div className='flex-1 text-center'>
          ...
          <div className='flex items-center justify-center gap-2'>
            ...
            <span className='inline-flex items-center gap-1 rounded-full bg-moccaccino-100/80 px-3 py-1 text-sm font-semibold text-moccaccino-600'>
